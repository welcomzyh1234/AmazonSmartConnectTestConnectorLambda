...
public class RejectOrder extends OrderProcessAPIProxy {

    public RejectOrder(HttpClient httpClient, APIGatewayV2ProxyRequestEvent event, Context context) {
    ...
    protected HttpUriRequest getHttpRequest() throws URISyntaxException {
        ...
        HttpPut httpRequest = new HttpPut(
                Util.getBaseUriBuilder()
                        .setPath(getPathFromPutMethod(requestPayload, "reject-order"))
                        .build()
        );
