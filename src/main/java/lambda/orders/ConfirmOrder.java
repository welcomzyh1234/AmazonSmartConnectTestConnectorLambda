...
public class ConfirmOrder extends OrderProcessAPIProxy {

    public ConfirmOrder(HttpClient httpClient, APIGatewayV2ProxyRequestEvent event, Context context) {
    ...
    protected HttpUriRequest getHttpRequest() throws URISyntaxException {
        ...
        return new HttpPut(
                Util.getBaseUriBuilder()
                        .setPath(getPathFromPutMethod(requestPayload, "confirm-order"))
                        .build()
        );
    }
}
