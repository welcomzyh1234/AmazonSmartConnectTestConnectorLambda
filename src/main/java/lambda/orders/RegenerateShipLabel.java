...
public class RegenerateShipLabel extends OrderProcessAPIProxy {

    public RegenerateShipLabel(HttpClient httpClient, APIGatewayV2ProxyRequestEvent event, Context context) {
    ...
    protected HttpUriRequest getHttpRequest() throws URISyntaxException {
        ...
        return new HttpPut(
                Util.getBaseUriBuilder()
                        .setPath(getPathFromPutMethod(requestPayload, "regenerate-ship-label"))
                        .setCustomQuery(
                                String.format(
