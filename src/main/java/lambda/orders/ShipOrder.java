...
public class ShipOrder extends OrderProcessAPIProxy {

    public ShipOrder(HttpClient httpClient, APIGatewayV2ProxyRequestEvent event, Context context) {
    ...
    protected HttpUriRequest getHttpRequest() throws URISyntaxException {
        ...
        return new HttpPut(
                Util.getBaseUriBuilder()
                        .setPath(getPathFromPutMethod(requestPayload, "ship-order"))
                        .build()
        );
    }
}
